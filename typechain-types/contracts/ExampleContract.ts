...
export interface ExampleContractInterface extends utils.Interface {
  functions: {
    "doSomething(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "doSomething", values: [string]): string;
...
export interface ExampleContract extends BaseContract {
  ...
  doSomething(parameter: string, overrides?: CallOverrides): Promise<string>;
